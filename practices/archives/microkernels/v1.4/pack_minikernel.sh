...
PRIMER_FILES=(
  ...
  "kernel/00_kernel_contract_mini.md"
#  "kernel/10_kernel_map.md"
...
#  "modules/meta/multi_system_relational_ledger.md"
  ...
  "modules/practices/cards/card_index.md"
  "modules/practices/cards/cards.md"
  "modules/practices/cards/card_bank.md"
  "modules/practices/cards/card_template.md"
  "modules/practices/cards/minotaur_bank.md"
