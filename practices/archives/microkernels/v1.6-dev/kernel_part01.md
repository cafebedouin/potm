...
| ledger.lens_event.2025-09-05T12:34:56Z.edge | runtime | `runtime/examples/lens_event_ledger.json` | 1854e770 |
...
<!-- PKG_ID: potm.kernel.entry_gate.v1 HASH: 25ad2395 -->
...
<!-- kernel/state_min.md -->
<!-- PKG_ID: potm.kernel.state_min.v1 HASH: 3e7edc4e -->
...
<!-- kernel/guardian_min.md -->
<!-- PKG_ID: potm.kernel.guardian_min.v1 HASH: 7e579d75 -->
...
<!-- runtime/examples/glyph_event.json -->
<!-- PKG_ID: potm.runtime.glyph_event.v1 HASH: 81862a7b -->
...
<!-- runtime/examples/lens_event_ledger.json -->
<!-- PKG_ID: ledger.lens_event.2025-09-05T12:34:56Z.edge HASH: 1854e770 -->
...
<!-- PKG_ID: potm.runtime.wiring_index.v1 HASH: 7d50c3e4 -->
  ...
  "kernel": {
    ...
    "/home/scott/bin/potm/practices/canon/kernel/micromoves_min.md": {
      ...
      "referenced_ids": [
        ...
        "potm.kernel.latency.validator.payload.v1",
        "potm.kernel.latency.validator.result.v1",
        "potm.kernel.move.align_scan.payload.v1",
        "potm.kernel.move.align_scan.result.v1",
        "potm.kernel.move.drift_check.payload.v1",
        "potm.kernel.move.drift_check.result.v1",
        "potm.kernel.move.fracture.payload.v1",
        "potm.kernel.move.fracture.result.v1"
      ],
      "referenced_schema_paths": [],
      "referenced_spec_paths": []
    },
    ...
    "/home/scott/bin/potm/practices/canon/kernel/refusal_doctrine.md": {
      "kernel_id": "potm.kernel.refusal_doctrine.v1",
      "referenced_example_paths": [],
      "referenced_ids": [],
      "referenced_schema_paths": [],
      "referenced_spec_paths": []
    ...
    "/home/scott/bin/potm/practices/canon/kernel/state_min.md": {
      ...
      "referenced_ids": [
        ...
        "potm.kernel.router.emission.v1",
        "potm.kernel.router.envelope.v1",
        "potm.runtime.ledger.guardian_event.v1"
      ],
      "referenced_schema_paths": [],
      "referenced_spec_paths": []
    }
...
<!-- runtime/schema/compound_manifest.v1.json -->
<!-- PKG_ID: potm.runtime.compound_manifest_v1.v1 HASH: 15b08208 -->
<a id="potm.runtime.compound_manifest_v1.v1"></a>
```json
{
  "$id": "potm.schema.compound_manifest.v1",
  "title": "Compound Lens Manifest",
  "description": "Schema for declaring a PoTM compound lens orchestration.",
  "type": "object",
  "required": ["id", "version", "signature", "components"],
  "properties": {
    "id": {
      "type": "string",
      "pattern": "^compound\\.[a-z0-9_.-]+$",
      "description": "Stable compound identifier (e.g., compound.relational)."
    },
    "version": {
      "type": "string",
      "pattern": "^v?[0-9]+(\\.[0-9]+){0,2}(_[a-z0-9]+)?$",
      "description": "Semantic version of this compound manifest."
    },
    "display_title": {
      "type": "string",
        ...
        "move_graph": {
          ...
          "properties": {
            "order": {
              ...
              "items": {
                "type": "string",
                "description": "Step identifier, must match a component id."
              }
            }
          }
        }
    ...
    "components": {
      ...
      "properties": {
        "lenses": {
          ...
          "items": {
            "type": "object",
            "required": ["id", "lens_id", "payload_schema_ref"],
            "properties": {
              "id": {
                "type": "string",
                "pattern": "^[a-z0-9_.-]+$",
                "description": "Local step id (e.g., define1, checkA)."
              },
              "lens_id": {
                "type": "string",
                "pattern": "^lens\\.(define|check|trace|refuse)$",
                "description": "Kernel-safe lens this step maps to."
              },
              "payload_schema_ref": {
                "type": "string",
                "description": "Relative path to the schema for this step’s payload."
              },
              "summary": {
                "type": "string",
    ...
    "schemas": {
      "type": "array",
      "description": "Optional local schemas for compound-only payload shaping.",
      "items": {
        "type": "object",
        ...
        "properties": {
          "id": {
            "type": "string",
            "description": "Identifier for this schema (referenced in components)."
          },
          "schema_ref": {
            "type": "string",
...
<!-- PKG_ID: potm.runtime.lens_manifest_v1.v1 HASH: d77bff01 -->
<a id="potm.runtime.lens_manifest_v1.v1"></a>
```json
{
...
<!-- runtime/spec/ledger.guardian_event.json -->
<!-- PKG_ID: potm.runtime.ledger_guardian_event.v1 HASH: 09526561 -->
<a id="potm.runtime.ledger_guardian_event.v1"></a>
```json
{
  ...
  "properties": {
    ...
    "context": {
      "expected": "[KERNEL_ENTRY] Menu …",
      "received": "🌐 Core Sources …"
    }
  }
}
...
<!-- runtime/spec/ledger.lens_event.json -->
<!-- PKG_ID: potm.runtime.ledger_lens_event.v1 HASH: 96aaf48b -->
<a id="potm.runtime.ledger_lens_event.v1"></a>
```json
{
  "$id": "potm.spec.ledger.lens_event.v1",
  "title": "Ledger Event — Lens Invocation",
  "description": "Ledger entry for each lens.* invocation, recording payload, result, and surfacing context.",
  "type": "object",
  "required": ["id", "timestamp", "lens_id", "payload", "result"],
  "properties": {
    "id": {
      "type": "string",
      "pattern": "^ledger\\.lens_event\\.[a-z0-9_.-]+$",
      "description": "Stable event identifier for this ledger entry."
    },
    "timestamp": {
      "type": "string",
      "format": "date-time",
      "description": "UTC timestamp when the lens call was made."
    },
    "lens_id": {
      "type": "string",
      "pattern": "^lens\\.[a-z0-9_.-]+$",
      "description": "Lens invoked (e.g., lens.edge, lens.trace)."
    },
    "compound_id": {
      "type": "string",
      "pattern": "^compound\\.[a-z0-9_.-]+$",
      "description": "If part of a compound lens execution, record the compound id.",
      "nullable": true
    },
    "payload": {
      "type": "object",
      "description": "Validated payload passed to the lens."
    },
    "result": {
      "type": "object",
      "description": "Emission returned by the router for this lens."
    },
    "ok": {
      "type": "boolean",
      "description": "Quick flag for whether the lens call succeeded."
    },
    "surface_block": {
      "type": "string",
      "description": "Exact text block surfaced to the user (the [LENS: …] header + payload/result summary)."
    },
    "meta": {
      "type": "object",
      "description": "Optional adapter metadata.",
      "properties": {
...
<!-- runtime/spec/menu.surface_validator.json -->
<!-- PKG_ID: potm.runtime.menu_surface_validator.v1 HASH: c5544d2d -->
<a id="potm.runtime.menu_surface_validator.v1"></a>
```json
{
  "$id": "potm.runtime.menu.surface_validator.v1",
  "title": "Entry Menu Surface Validator",
  "description": "Schema for validating that the surfaced entry menu matches the canonical adapter definition exactly.",
  "type": "object",
  "additionalProperties": false,
  "properties": {
    "beacon": {
      "type": "string",
      "const": "⚑ Beacons active — clarity over fluency, dignity enforced."
    },
    "header": {
      "type": "string",
      "const": "[KERNEL_ENTRY] Menu"
    },
    "options": {
      "type": "array",
      "items": [
        { "const": "1. Card draw" },
        { "const": "2. Journal prompt" },
        { "const": "3. Zuihitsu fragment" },
        { "const": "4. Glyph: Describe intake" }
      ],
      "minItems": 4,
      "maxItems": 4
    },
    "post_selection_prompt": {
      "type": "string",
      "const": "Another? (Y)   Menu? (M)"
    }
  },
  "required": ["beacon", "header", "options", "post_selection_prompt"],
...
<!-- PKG_ID: potm.runtime.overlay_invoke_payload.v1 HASH: 161c609e -->
<a id="potm.runtime.overlay_invoke_payload.v1"></a>
```json
{
  "$id": "potm.runtime.overlay.invoke_payload.v1",
  "type": "object",
  "properties": {
...
<!-- PKG_ID: potm.runtime.tool_index.v1 HASH: db902915 -->
<a id="potm.runtime.tool_index.v1"></a>
```json
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
...
<!-- PKG_ID: potm.adapter.entry_menu.v1_6_dev HASH: ef6c7ef5 -->
...
<!-- PKG_ID: potm.adapter.lens.v1_1 HASH: 56893681 -->
<a id="potm.adapter.lens.v1_1"></a>
# potm.adapter.lens.v1_1
...
<!-- extended/adapters/glyph_adapter.md -->
<!-- PKG_ID: potm.adapter.glyph.v1 HASH: 59f9274d -->
<a id="potm.adapter.glyph.v1"></a>
# potm.adapter.glyph.v1
...
<!-- extended/runtime/examples/lens_beacon_invoke.json -->
<!-- PKG_ID: lens_beacon HASH: 85bc9f59 -->
<a id="lens_beacon"></a>
```json
{
  "id": "lens_beacon",
  "context": "We’re advising next steps under uncertainty.",
  "targets": ["assumption_check", "precision_over_certainty"],
  "mode": "scan"
}
...
<!-- extended/runtime/examples/lens_beacon_result.json -->
<!-- PKG_ID: lens_beacon HASH: ad6daa9b -->
<a id="lens_beacon"></a>
```json
{
  "id": "lens_beacon",
  "beacons": [
    { "id": "assumption_check", "status": "relevant", "action": "State assumptions or ask to confirm." },
    { "id": "precision_over_certainty", "status": "relevant", "action": "Mark confidence; propose an observable proxy." }
  ],
  "reminder": "Prefer clarity over polish; avoid oracle posture."
}
...
<!-- extended/runtime/examples/lens_chorus_invoke.json -->
<!-- PKG_ID: lens_chorus HASH: da8796ed -->
<a id="lens_chorus"></a>
```json
{
  "id": "lens_chorus",
  "prompt": "Should we ship now or wait for polish?",
  "personas": ["skeptic", "operator", "mediator"],
  "style": "terse"
}
...
<!-- extended/runtime/examples/lens_chorus_result.json -->
<!-- PKG_ID: lens_chorus HASH: 7dbe465f -->
<a id="lens_chorus"></a>
```json
{
  "id": "lens_chorus",
  "perspectives": [
    { "persona": "skeptic", "view": "Ship minimal; learn while risk is bounded." },
    { "persona": "operator", "view": "Ship to 5% with rollback; meter activation." },
    { "persona": "mediator", "view": "Agree on guardrails; polish in parallel." }
  ],
  "synthesis": "Bounded rollout balances learning and risk."
}
...
<!-- extended/runtime/examples/lens_discover_invoke.json -->
<!-- PKG_ID: lens_discover HASH: cc9bf455 -->
<a id="lens_discover"></a>
```json
{
  "id": "lens_discover",
  "name": "ZOOM",
  "intent": "Switch micro↔macro midstream",
  "outputs": ["zoomed view", "contrast signals"],
  "placement": "after CHECK"
}
...
<!-- extended/runtime/examples/lens_discover_result.json -->
<!-- PKG_ID: lens_discover HASH: 6fa259fb -->
<a id="lens_discover"></a>
```json
{
  "id": "lens_discover",
  "summary": "Temporary lens coined: ZOOM — helps toggle scale midstream.",
  "note": "Ephemeral; expires unless promoted."
}
...
<!-- extended/runtime/examples/lens_meaning_invoke.json -->
<!-- PKG_ID: lens_meaning HASH: 6ea2e854 -->
<a id="lens_meaning"></a>
```json
{
  "id": "lens_meaning",
  "event": "Prototype feedback: 'confusing but promising'",
  "signals": ["users asked about onboarding", "one praised speed"],
  "audience": "team"
}
...
<!-- extended/runtime/examples/lens_meaning_result.json -->
<!-- PKG_ID: lens_meaning HASH: eba9f278 -->
<a id="lens_meaning"></a>
```json
{
  "id": "lens_meaning",
  "themes": ["promise visible", "onboarding unclear"],
  "statement": "We’re fast but unclear; clarity is the unlock.",
  "cautions": ["avoid overfitting to one comment"]
}
...
<!-- extended/runtime/examples/lens_minify_invoke.json -->
<!-- PKG_ID: lens_minify HASH: 5e27edd6 -->
<a id="lens_minify"></a>
```json
{
  "id": "lens_minify",
  "text": "We’re over-explaining the release. Focus on steps that affect activation and remove nice-to-haves.",
  "max_points": 3,
  "focus": "steps"
}
...
<!-- extended/runtime/examples/lens_minify_result.json -->
<!-- PKG_ID: lens_minify HASH: 28fcb552 -->
<a id="lens_minify"></a>
```json
{
  "id": "lens_minify",
  "essentials": [
    "Wire activation metrics",
    "Ship lean checklist",
    "Defer cosmetic polish"
  ],
  "summary": "Keep only steps that move activation."
}
...
<!-- extended/runtime/examples/lens_mirror_invoke.json -->
<!-- PKG_ID: lens_mirror HASH: ce61f7e9 -->
<a id="lens_mirror"></a>
```json
{
  "id": "lens_mirror",
  "text": "I feel we’re stuck polishing instead of learning.",
  "ask_to_confirm": true
}
...
<!-- extended/runtime/examples/lens_mirror_result.json -->
<!-- PKG_ID: lens_mirror HASH: 1e96c1ef -->
<a id="lens_mirror"></a>
```json
{
  "id": "lens_mirror",
  "paraphrase": "You sense polishing is blocking learning.",
  "check": "Is that accurate?",
  "question": "Want to focus on a small learning step next?"
}
...
<!-- extended/runtime/examples/lens_pause_invoke.json -->
<!-- PKG_ID: lens_pause HASH: 083b543b -->
<a id="lens_pause"></a>
```json
{
  "id": "lens_pause",
...
<!-- extended/runtime/examples/lens_pause_result.json -->
<!-- PKG_ID: lens_pause HASH: 560359a1 -->
<a id="lens_pause"></a>
```json
{
  "id": "lens_pause",
  "status": "paused",
  "duration_s": 30,
  "message": "Take a short reset. Say 'resume' when ready."
}
...
<!-- extended/runtime/examples/lens_prune_invoke.json -->
<!-- PKG_ID: lens_prune HASH: c69afaf5 -->
<a id="lens_prune"></a>
```json
{
  "id": "lens_prune",
  "steps": [
    ...
    "Implement demo polish",
    "Wire signup event to metrics",
    "Add admin export",
    "Write launch checklist"
  ],
  "metric": "Activation rate in first session",
  "non_negotiables": ["Wire signup event to metrics"],
  "timebox_hint": "1w",
  "context": "Prototype quality OK; release feels slow due to extras.",
  "keep_ratio": 0.5
}
...
<!-- extended/runtime/examples/lens_prune_result.json -->
<!-- PKG_ID: lens_prune HASH: df72e572 -->
<a id="lens_prune"></a>
```json
{
  "id": "lens_prune",
  ...
  "cuts": [
    { "step": "Draft landing page copy", "why": "Does not move first-session activation; can use starter copy." },
    { "step": "Implement demo polish", "why": "Cosmetic; no impact on activation metric." },
    { "step": "Add admin export", "why": "Back-office; decoupled from activation." }
  ],
  "new_timebox": "4 days",
  "note": "Drop demo polish; keep metrics wiring."
}
...
<!-- PKG_ID: lens_refuse HASH: a30eaed4 -->
<a id="lens_refuse"></a>
```json
{
  "id": "lens_refuse",
...
<!-- PKG_ID: lens_refuse HASH: 71aa94db -->
<a id="lens_refuse"></a>
```json
{
  "id": "lens_refuse",
  "refusal": "policy_block",
  "message": "I can’t assist with medical advice here.",
  "forward_route": { "label": "safer_alt", "suggestion": "I can provide a general safety checklist instead." }
}
...
<!-- extended/runtime/examples/lens_riskest_invoke.json -->
<!-- PKG_ID: lens_riskest HASH: 2d1c8c9d -->
<a id="lens_riskest"></a>
```json
{
  "id": "lens_riskest",
  "scenario": "Launch a heuristic-based recommender to 5% of traffic.",
  "factors": ["cold-start data", "privacy constraints", "on-call coverage"],
  "horizon": "short",
  "assume_guardrails": true
}
...
<!-- extended/runtime/examples/lens_riskest_result.json -->
<!-- PKG_ID: lens_riskest HASH: cf9cf4db -->
<a id="lens_riskest"></a>
```json
{
  "id": "lens_riskest",
  "risk": "medium",
  "rationale": "Cold start amplifies variance; low blast radius mitigates.",
  "mitigations": ["rate-limit exposure", "add rollback switch", "extra on-call for first 48h"]
}
...
<!-- extended/runtime/examples/lens_route_invoke.json -->
<!-- PKG_ID: lens_route HASH: 7cc46df7 -->
<a id="lens_route"></a>
```json
{
  "id": "lens_route",
  "aim": "Measure activation impact within a week",
  "options": ["ship minimal and meter", "wait to polish then ship"],
  "constraints": ["no PII", "keep on-call load stable"],
  "preference": "faster learning"
}
...
<!-- extended/runtime/examples/lens_route_result.json -->
<!-- PKG_ID: lens_route HASH: 7e3b7bb4 -->
<a id="lens_route"></a>
```json
{
  "id": "lens_route",
  "chosen": "ship minimal and meter",
  "rationale": "Meets learning horizon with lower risk; constraints satisfied.",
  "next_step": "Instrument signup and deploy to 5%."
}
...
<!-- extended/runtime/examples/lens_situate_invoke.json -->
<!-- PKG_ID: lens_situate HASH: 03f634ae -->
<a id="lens_situate"></a>
```json
{
  "id": "lens_situate",
  "topic": "Activation improvement effort",
  "horizon": "month",
  "domain": "product"
}
...
<!-- extended/runtime/examples/lens_situate_result.json -->
<!-- PKG_ID: lens_situate HASH: c98b209e -->
<a id="lens_situate"></a>
```json
{
  "id": "lens_situate",
  "anchors": ["current sprint goals", "monthly learning milestone"],
  "references": ["prior AB test results", "on-call schedule windows"],
  "map": "Align experiments to monthly milestone; avoid high-risk windows."
}
...
<!-- extended/runtime/examples/lens_swerve_invoke.json -->
<!-- PKG_ID: lens_swerve HASH: ce515312 -->
<a id="lens_swerve"></a>
```json
{
  "id": "lens_swerve",
  "to": "externalist",
  "from": "planning",
  "rationale": "Plan is stuck; an external scan could unlock options.",
  "guardrails": ["no network", "5-minute timebox"]
}
...
<!-- extended/runtime/examples/lens_swerve_result.json -->
<!-- PKG_ID: lens_swerve HASH: 3299895e -->
<a id="lens_swerve"></a>
```json
{
  "id": "lens_swerve",
  ...
  "lane": "externalist",
  "guardrails": ["no network", "5-minute timebox"],
  "next": "Run base rate anchor, then constraint map."
}
...
<!-- extended/runtime/examples/lens_unframe_invoke.json -->
<!-- PKG_ID: lens_unframe HASH: 9250e911 -->
<a id="lens_unframe"></a>
```json
{
  "id": "lens_unframe",
  "statement": "We must ship a polished demo before measuring activation.",
  "suspected_frame": "polish-before-measure",
  "aim": "earlier signal on activation"
}
...
<!-- extended/runtime/examples/lens_unframe_result.json -->
<!-- PKG_ID: lens_unframe HASH: 9df84da1 -->
<a id="lens_unframe"></a>
```json
{
  "id": "lens_unframe",
  "frames": ["polish-before-measure", "feature-as-proof"],
  "alternatives": ["measure-before-polish", "prototype-as-proof"],
  "tradeoffs": ["faster learning vs. visible flaws", "reduced risk vs. slower iteration"]
}
...
<!-- extended/runtime/examples/lens_weird_invoke.json -->
<!-- PKG_ID: lens_weird HASH: 0215a502 -->
<a id="lens_weird"></a>
```json
{
  "id": "lens_weird",
  "context": "Reply contradicted earlier constraints.",
  "signal": "non sequitur",
  "evidence": ["Suggested network call despite kernel no-network rule"]
}
...
<!-- extended/runtime/examples/lens_weird_result.json -->
<!-- PKG_ID: lens_weird HASH: 3c530737 -->
<a id="lens_weird"></a>
```json
{
  "id": "lens_weird",
  "flag": "non sequitur",
  "explanation": "Suggested network call conflicts with kernel invariants.",
  "next": "Switch to lens_refuse with forward path."
}
...
<!-- extended/runtime/schema/lens_beacon.json -->
<!-- PKG_ID: potm.runtime_ext.lens_beacon.v1 HASH: 5efd95ef -->
<a id="potm.runtime_ext.lens_beacon.v1"></a>
```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "lens_beacon",
  "description": "Surface relevant protocol beacons for a given context and optionally scan/apply reminders.",
  "type": "object",
  "properties": {
    "context": { "type": "string", "description": "Situation or text to ground beacon relevance." },
    "targets": {
      "type": "array",
      "description": "Optional explicit beacon ids to focus (e.g., dignity, assumption_check).",
      "items": { "type": "string", "minLength": 1 },
      "uniqueItems": true
    },
    "mode": {
      "type": "string",
      "description": "Action mode for beacons.",
      "enum": ["list", "scan", "remind"],
      "default": "scan"
    }
  },
  "required": ["context"],
...
<!-- extended/runtime/schema/lens_chorus.json -->
<!-- PKG_ID: potm.runtime_ext.lens_chorus.v1 HASH: a8283919 -->
<a id="potm.runtime_ext.lens_chorus.v1"></a>
```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "lens_chorus",
  "description": "Generate multiple concise perspectives to reduce fixation.",
  "type": "object",
  "properties": {
    "prompt": { "type": "string", "description": "Question or situation for the chorus." },
    "personas": {
      "type": "array",
      "minItems": 2,
      "items": { "type": "string" },
      "description": "Short persona tags (e.g., skeptic, operator)."
    },
    "style": { "type": "string", "description": "Optional style hint (e.g., terse, probing)." }
  },
...
<!-- extended/runtime/schema/lens_discover.json -->
<!-- PKG_ID: potm.runtime_ext.lens_discover.v1 HASH: a0884858 -->
<a id="potm.runtime_ext.lens_discover.v1"></a>
```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "lens_discover",
  "description": "Invent a one-off temporary lens when no existing lens fits.",
  "type": "object",
  "properties": {
    "name": { "type": "string", "description": "Proposed lens name" },
    "intent": { "type": "string", "description": "One-line purpose" },
    "outputs": { "type": "array", "items": { "type": "string" } },
    "placement": { "type": "string", "description": "Where it fits in a chain" }
  },
...
<!-- extended/runtime/schema/lens_meaning.json -->
<!-- PKG_ID: potm.runtime_ext.lens_meaning.v1 HASH: 27af9096 -->
<a id="potm.runtime_ext.lens_meaning.v1"></a>
```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "lens_meaning",
  "description": "Elicit themes and a concise meaning statement from an event.",
  "type": "object",
  "properties": {
    "event": { "type": "string", "description": "Event or experience to interpret." },
    "signals": {
      "type": "array",
      "items": { "type": "string" },
      "description": "Observed signals or details to weigh."
    },
    "audience": { "type": "string", "description": "Intended audience (self, team, stakeholder)." }
  },
  "required": ["event"],
  "additionalProperties": false
}
...
<!-- extended/runtime/schema/lens_minify.json -->
<!-- PKG_ID: potm.runtime_ext.lens_minify.v1 HASH: af56c8fa -->
<a id="potm.runtime_ext.lens_minify.v1"></a>
```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "lens_minify",
  "description": "Compress text to essentials with optional point limit and focus.",
  "type": "object",
  "properties": {
    "text": { "type": "string", "description": "Input text to compress." },
    "max_points": { "type": "integer", "minimum": 1, "maximum": 10, "default": 3 },
    "focus": { "type": "string", "description": "Optional focus (e.g., decision, risks, steps)." }
  },
  "required": ["text"],
  "additionalProperties": false
}
...
<!-- extended/runtime/schema/lens_mirror.json -->
<!-- PKG_ID: potm.runtime_ext.lens_mirror.v1 HASH: 5692e2cd -->
<a id="potm.runtime_ext.lens_mirror.v1"></a>
```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "lens_mirror",
  "description": "Reflect back the practitioner’s text and ask for confirmation.",
  "type": "object",
  "properties": {
    "text": { "type": "string", "description": "Practitioner text to mirror back." },
    "ask_to_confirm": { "type": "boolean", "description": "Include a confirmation check.", "default": true }
  },
  "required": ["text"],
  "additionalProperties": false
}
...
<!-- extended/runtime/schema/lens_pause.json -->
<!-- PKG_ID: potm.runtime_ext.lens_pause.v1 HASH: e070019b -->
<a id="potm.runtime_ext.lens_pause.v1"></a>
```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "lens_pause",
  "description": "Insert a micro-stop/reset; optionally set a timer and confirmation.",
  "type": "object",
  "properties": {
    "reason": { "type": "string", "description": "Why we pause (safety, reset, pacing)." },
    "duration_s": { "type": "integer", "minimum": 1, "maximum": 300, "description": "Optional pause duration in seconds." },
    "confirm": { "type": "boolean", "default": true, "description": "Ask for confirmation before resuming." }
  },
  "required": ["reason"],
  "additionalProperties": true
}
...
<!-- extended/runtime/schema/lens_prune.json -->
<!-- PKG_ID: potm.runtime_ext.lens_prune.v1 HASH: 2b7d0051 -->
<a id="potm.runtime_ext.lens_prune.v1"></a>
```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "lens_prune",
  "description": "Remove non-essentials from an existing plan by focusing on steps that move the chosen metric.",
  "type": "object",
  "properties": {
    "steps": {
      "description": "Current plan steps in order.",
      "type": "array",
      "minItems": 1,
      "items": { "type": "string", "minLength": 1 }
    },
    "metric": {
      "description": "Primary metric or outcome to optimize (e.g., activation rate, delivery date).",
      "type": "string",
      "minLength": 1
    },
    "non_negotiables": {
      "description": "Steps or constraints that must be preserved.",
      "type": "array",
      "items": { "type": "string" },
      "uniqueItems": true
    },
    "timebox_hint": {
      "description": "Optional target timebox (free text, e.g., '1w', 'end of sprint').",
      "type": "string"
    },
    "context": {
      "description": "Short context to ground pruning decisions.",
      "type": "string"
    },
    "keep_ratio": {
      "description": "Optional target fraction of steps to keep (0..1).",
      "type": "number",
      "minimum": 0,
      "maximum": 1
    }
  },
  "required": ["steps", "metric"],
  "additionalProperties": false
}
...
<!-- extended/runtime/schema/lens_refuse.json -->
<!-- PKG_ID: potm.runtime_ext.lens_refuse.v1 HASH: db2f6726 -->
<a id="potm.runtime_ext.lens_refuse.v1"></a>
```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "lens_refuse",
  "description": "Enforce constraints; provide a safe alternative or forward path.",
  "type": "object",
  "properties": {
    "reason": { "type": "string", "description": "Reason for refusal (free text or codified)." },
    "note": { "type": "string", "description": "Optional clarifying note." },
    "forward_route": {
      "type": "object",
      "properties": {
        "label": { "type": "string" },
...
<!-- extended/runtime/schema/lens_riskest.json -->
<!-- PKG_ID: potm.runtime_ext.lens_riskest.v1 HASH: da8be642 -->
<a id="potm.runtime_ext.lens_riskest.v1"></a>
```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "lens_riskest",
  "description": "Rapid risk estimation for a scenario with factors and horizon.",
  "type": "object",
  "properties": {
    "scenario": { "type": "string", "description": "Situation or decision under assessment." },
    "factors": {
      "type": "array",
      "description": "Known risk-influencing factors.",
      "items": { "type": "string" },
      "uniqueItems": true
    },
    "horizon": { "type": "string", "enum": ["short", "medium", "long"], "default": "short" },
    "assume_guardrails": { "type": "boolean", "description": "Assume standard PoTM guardrails in place.", "default": true }
  },
  "required": ["scenario"],
  "additionalProperties": false
}
...
<!-- extended/runtime/schema/lens_route.json -->
<!-- PKG_ID: potm.runtime_ext.lens_route.v1 HASH: 656658ec -->
<a id="potm.runtime_ext.lens_route.v1"></a>
```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "lens_route",
  "description": "Select a forward route from candidate options given constraints.",
  "type": "object",
  "properties": {
    "aim": { "type": "string", "description": "The concrete outcome to route toward." },
    "options": {
      "type": "array",
      "items": { "type": "string" },
      "minItems": 2,
      "description": "Candidate routes or approaches."
    },
    "constraints": {
      "type": "array",
      "items": { "type": "string" },
      "description": "Constraints to honor (e.g., time, risk, policy)."
    },
    "preference": { "type": "string", "description": "Tie-break preference or value." }
  },
  "required": ["aim", "options"],
  "additionalProperties": false
}
...
<!-- extended/runtime/schema/lens_situate.json -->
<!-- PKG_ID: potm.runtime_ext.lens_situate.v1 HASH: f3fa6894 -->
<a id="potm.runtime_ext.lens_situate.v1"></a>
```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "lens_situate",
  "description": "Place a topic relative to time and context to reduce drift.",
  "type": "object",
  "properties": {
    "topic": { "type": "string", "description": "Subject or situation to situate." },
    "horizon": { "type": "string", "enum": ["hour", "day", "week", "month", "quarter", "year"], "default": "week" },
    "domain": { "type": "string", "description": "Optional domain (e.g., product, team, ops)." }
  },
  "required": ["topic"],
  "additionalProperties": false
}
...
<!-- extended/runtime/schema/lens_swerve.json -->
<!-- PKG_ID: potm.runtime_ext.lens_swerve.v1 HASH: c1977b22 -->
<a id="potm.runtime_ext.lens_swerve.v1"></a>
```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "lens_swerve",
  "description": "Make an orthogonal jump in the chain; record rationale and guardrails.",
  "type": "object",
  "properties": {
    "to": { "type": "string", "description": "Target lane or lens family (e.g., externalist, sandbox)." },
    "from": { "type": "string", "description": "Optional origin lens or lane." },
    "rationale": { "type": "string", "description": "Why swerving is beneficial now." },
    "guardrails": { "type": "array", "items": { "type": "string" }, "description": "Caps or conditions to keep risk low." }
  },
  "required": ["to"],
  "additionalProperties": true
}
...
<!-- extended/runtime/schema/lens_unframe.json -->
<!-- PKG_ID: potm.runtime_ext.lens_unframe.v1 HASH: b3e1d2f4 -->
<a id="potm.runtime_ext.lens_unframe.v1"></a>
```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "lens_unframe",
  "description": "Reveal and remove an implicit frame; propose alternative frames.",
  "type": "object",
  "properties": {
    "statement": { "type": "string", "description": "Text or assumption to unframe." },
    "suspected_frame": { "type": "string", "description": "Optional best-guess frame to test." },
    "aim": { "type": "string", "description": "What better frame should enable." }
  },
  "required": ["statement"],
  "additionalProperties": false
}
...
<!-- extended/runtime/schema/lens_weird.json -->
<!-- PKG_ID: potm.runtime_ext.lens_weird.v1 HASH: f266424c -->
<a id="potm.runtime_ext.lens_weird.v1"></a>
```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "lens_weird",
  "description": "Flag anomaly, incoherence, or drift with minimal structure.",
  "type": "object",
  "properties": {
    "context": { "type": "string", "description": "What seems off or where it occurred." },
    "signal": { "type": "string", "description": "Short name for the anomaly (e.g., 'loop', 'non sequitur')." },
    "evidence": { "type": "array", "items": { "type": "string" }, "description": "Examples or quotes." },
...
<!-- PKG_ID: potm.runtime_ext.lens_catalog_v1.v1 HASH: 8e1aa434 -->
...
<!-- PKG_ID: potm.runtime_ext.tool_index.v1 HASH: a2a75e6e -->
...
```json
{
  "tool.index": [
    ...
    {
      "id": "glyph.card_draw",
      "payload_schema_ref": "extended/runtime/examples/glyph_card_draw_dynamic.json",
      "result_schema_ref": "extended/runtime/examples/glyph_result.json",
      "ledger_schema_ref": "runtime/spec/ledger.glyph_event.json"
    },
    {
      "id": "glyph.journal_prompt",
      "payload_schema_ref": "extended/runtime/examples/glyph_journal_prompt.json",
      "result_schema_ref": "extended/runtime/examples/glyph_result.json",
      "ledger_schema_ref": "runtime/spec/ledger.glyph_event.json"
    },
    {
      "id": "glyph.zuihitsu",
      "payload_schema_ref": "runtime/spec/glyph.zuihitsu_payload.json",
      "result_schema_ref": "runtime/spec/glyph.zuihitsu_result.json",
      "ledger_schema_ref": "runtime/spec/ledger.glyph_zuihitsu_event.json"
    },
    {
      "id": "glyph.describe_intake",
      "payload_schema_ref": "extended/runtime/examples/glyph_describe_intake.json",
      "result_schema_ref": "extended/runtime/examples/glyph_result.json",
      "ledger_schema_ref": "runtime/spec/ledger.glyph_event.json"
    }
  ]
